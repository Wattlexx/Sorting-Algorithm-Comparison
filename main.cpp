/*
Sorting program.
This program takes a file of random numbers and creates new files for each sorting algorithm used.
Afterwards a comparison.txt file is created the compares the sorting methods.
Nicholas Pinney
Student ID: 0696399
*/
#include <iostream>
